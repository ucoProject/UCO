...
### Current Release
The current release of UCO is 1.5.0.
...
More detail of improvements is documented in the [UCO 1.5.0 release notes](https://unifiedcyberontology.org/releases/1.5.0/).
